        ...
        headers: [
          ...
          // In production, consider nonce-based CSP for tighter security.
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://pub-60b4679aa7b4477b838c988b7a0b3d45.r2.dev https://*.r2.dev https://*.caftan-gharnata.com https://*.caftan-gharnata.workers.dev",
              ...
              "connect-src 'self' https://api.cloudflare.com https://pub-60b4679aa7b4477b838c988b7a0b3d45.r2.dev https://*.r2.dev https://*.r2.cloudflarestorage.com https://api.telegram.org https://www.caftan-gharnata.com https://caftan-gharnata.com https://*.caftan-gharnata.workers.dev",
